...
func (s *AddressService) Create(ctx context.Context, userID uint, req CreateAddressRequest) (*AddressResponse, error) {
...
func (s *AddressService) Update(ctx context.Context, id uint, req UpdateAddressRequest) (*AddressResponse, error) {
	_, err := s.db.ExecContext(ctx, `
...
func (s *AddressService) FindByID(ctx context.Context, id uint) (*AddressResponse, error) {
	...
	if districtID.Valid {
		v := uint(districtID.Int64)
		a.DistrictID = &v
	}
	return &a, nil
}

func (s *AddressService) FindByUserID(ctx context.Context, userID uint) ([]AddressResponse, error) {
...
func (s *AddressService) IsOwner(ctx context.Context, addressID, userID uint) (bool, error) {
	var count int
	err := s.db.QueryRowContext(ctx, `
